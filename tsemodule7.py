...
class HighPriceManager:
    ...
    def get_highest_close_price(self, newfile=False, standard=False, progress=True):
        ...
        for stockname in self.stocknames:
            ...
            max_close = df.loc[max_index, 'Close']

            highest_close_prices.append({"Max Close": max_close, "Date": max_index,"Stock": stockname})
